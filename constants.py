...
ROOMS = {
    ...
    'garden': {
        ...
        'exits': {'south': 'armory', 'east': 'fountain'},
        'items': ['flower'],
        'puzzle': ('Перед вами ворота. Чтобы открыть, назовите число месяцев в году.', '12')
    },
    'fountain': {
        'description': 'Круглый фонтан с чистой водой. В воде виднеется что-то блестящее.',
        'exits': {'west': 'garden'},
        'items': ['golden_coin'],
        'puzzle': None
    }
