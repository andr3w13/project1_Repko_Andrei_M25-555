...
ROOMS = {
    ...
    'hall': {
        ...
        'items': [],
        'puzzle': ('На пьедестале надпись: "Назовите число, которое ' + \
    ...
    'garden': {
        'description': 'Таинственный сад с высокими кустами. Воздух пахнет цветами.',
        'exits': {'south': 'armory'},
        'items': ['flower'],
        'puzzle': ('Перед вами ворота. Чтобы открыть, назовите число месяцев в году.', 
                   '12')
    },
    'fountain': {
        'description': 'Круглый фонтан с чистой водой. ' + \
        'В воде виднеется что-то блестящее.',
        'exits': {'west': 'garden'},
        'items': ['treasure_key'],
        'puzzle': None
    }
